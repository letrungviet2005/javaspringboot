                                                ...
                                                <div class="row g-4">
                                                    <div class="col-lg-6">
                                                        <div class="border rounded">
                                                            <a href="#">
                                                                <img src="/client/img/single-item.jpg"
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <p class="mb-4">Susp endisse ultricies nisi vel quam suscipit.
                                                            Sabertooth
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="tab-content mb-5">
                                                            <div class="tab-pane active" id="nav-about" role="tabpanel"
                                                                ...
                                                                <p>Sabertooth peacock flounder; chain pickerel
                                                            ...
                                                            <div class="tab-pane" id="nav-mission" role="tabpanel"
                                                                ...
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="">
                                                                        <p class="mb-2" style="font-size: 14px;">April
                                                                            12, 2024</p>
                                                                        ...
                                                                        <p>The generated Lorem Ipsum is therefore always
                                                                            ...
                                                                            non-characteristic
                                                                            words etc. Susp endisse ultricies nisi vel
                                                                            quam suscipit
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                <div class="d-flex">
                                                                    ...
                                                                    <div class="">
                                                                        ...
                                                                        <p class="text-dark">The generated Lorem Ipsum
                                                                            is therefore
                                                            ...
                                                            <div class="tab-pane" id="nav-vision" role="tabpanel">
                                                                <p class="text-dark">Tempor erat elitr rebum at clita.
                                                                    Diam dolor diam
                                                                    ipsum et tempor sit. Aliqu diam
                                                                    amet diam et eos labore. 3</p>
                                                                <p class="mb-0">Diam dolor diam ipsum et tempor sit.
                                                                    Aliqu diam amet
                                                                    diam et eos labore.
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-start">
                                                            <div class="rounded" style="width: 100px; height: 100px;">
                                                                <img src="/client/img/featur-1.jpg"
                                                                    class="img-fluid rounded" alt="Image">
                                                            </div>
                                                            <div>
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-start">
                                                            <div class="rounded" style="width: 100px; height: 100px;">
                                                                <img src="/client/img/featur-2.jpg"
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-start">
                                                            <div class="rounded" style="width: 100px; height: 100px;">
                                                                <img src="/client/img/featur-3.jpg"
                                                                    class="img-fluid rounded" alt="">
                                                            </div>
                                                            <div>
                                                                <h6 class="mb-2">Big Banana</h6>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="position-relative">
                                                            ...
                                                            <div class="position-absolute"
                                                                ...
                                                                <h3 class="text-secondary fw-bold">Fresh <br> Fruits
                                                                    <br> Banner
                                                                </h3>
                                                            </div>
                                                        </div>
